...
import HibernateManyToMany.Certificate;
import HibernateManyToMany.Employee;
...
public class ManageEmployee {
   ...
   public static void main(String[] args) {
      try{
         factory = new Configuration().configure("/HibernateManyToMany/hibernate.cfg.xml").buildSessionFactory();
      }catch (Throwable ex) {
