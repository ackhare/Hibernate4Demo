...
import com.chetan.HibernateMapMapping.Certificate;
import com.chetan.HibernateMapMapping.Employee;
...
public class ManageEmployee {
    ...
    public static void main(String[] args) {
        try {
            factory = new Configuration().configure("com/chetan/HibernateMapMapping/hibernate.cfg.xml").buildSessionFactory();
        } catch (Throwable ex) {
