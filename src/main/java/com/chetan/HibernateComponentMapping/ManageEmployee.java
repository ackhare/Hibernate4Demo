package com.chetan.HibernateComponentMapping;
...
public class ManageEmployee {
   ...
   public static void main(String[] args) {
      try{
         factory = new Configuration().configure("com/chetan/HibernateComponentMapping/hibernate.cfg.xml").buildSessionFactory();
      }catch (Throwable ex) {
